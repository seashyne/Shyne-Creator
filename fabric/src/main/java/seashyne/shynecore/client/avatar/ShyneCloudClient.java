...
public final class ShyneCloudClient {
    ...
    private static final Path SESSION_PATH = FabricLoader.getInstance().getConfigDir().resolve("shyne-creator").resolve("cloud-session.json");
    private static final Path CACHE_ROOT = FabricLoader.getInstance().getGameDir().resolve(".shyne-cache");
