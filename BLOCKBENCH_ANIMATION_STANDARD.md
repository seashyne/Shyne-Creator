...
เอกสารนี้ใช้กับ Shyne Creator `2.10.0-alpha-26.3` ซึ่งอ่าน `.bbmodel` ตามรูปแบบโปรเจกต์ Blockbench 5.1.5 โดยตรง และใช้ animation runtime เดียวกันบน Fabric กับ NeoForge
