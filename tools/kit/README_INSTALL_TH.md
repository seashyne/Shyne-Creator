...
คำสั่งนี้ใช้ชื่อโฟลเดอร์เป็นชื่อ Avatar และสร้าง `avatar.json`, `model.bbmodel` และ README แบบ Zero-Lua ให้อัตโนมัติ หากต้องการชื่อในเกมต่างออกไป ใช้ `--name "My Avatar"`; หากต้องการ ID คงที่ ใช้ `--id my.avatar`

ชื่อโฟลเดอร์ภาษาไทยใช้ได้ เครื่องมือจะสร้าง ID ที่ไม่ชนง่ายให้อัตโนมัติ
